...
.task("copy-images", function(cb) {
  ...
  .pipe(gulp.dest(package.dest.images));
})

/**
* copy libs
**/
.task("copy-libs", function(cb) {
  return gulp.src(package.paths.libs)
  .pipe(gulp.dest(package.dest.libs));
})
 ...
 */
.task("serve", ["bower", "clean", "lint", "less", "js", "copy-images", "copy-libs", "copy-html", "server"], function() {
  return gulp.watch([
...
.task("serve:minified", ["bower", "clean", "lint", "less:min", "js:min", "copy-images", "copy-libs", "copy-html", "server"], function() {
  return gulp.watch([
    package.paths.js, package.paths.jsx, package.paths.html, package.paths.less
  ], [
